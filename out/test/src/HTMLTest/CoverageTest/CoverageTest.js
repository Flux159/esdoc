...
describe('test coverage', () => {
  ...
  it('has coverage summary', () => {
    ...
    _util.assert.includes(doc, '[data-ice="totalCoverageCount"]', '280/351');
    _util.assert.equal(doc.find('[data-ice="file"] [data-ice="coverage"]').length, 119);
  });
