...
describe('TestTypeComplex', () => {
  ...
  it('has complex union type in generics.', () => {
    (0, _util.findParent)(doc, '[data-ice="summary"] [href$="#instance-method-method5"]', '[data-ice="target"]', doc => {
      _util.assert.includes(doc, null, 'method5(p1: Promise<string|number, Error>)');
      _util.assert.multiIncludes(doc, '[data-ice="signature"] a', ['https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise', 'https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String', 'https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number', 'https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error'], 'href');
    });
  });
  ...
  it('has complex union type with spread.', () => {
    (0, _util.findParent)(doc, '[data-ice="summary"] [href$="#instance-method-method6"]', '[data-ice="target"]', doc => {
      _util.assert.includes(doc, null, 'method6(p1: ...(number|string))');
